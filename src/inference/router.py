...
SYSTEM_CORE: str = (
    ...
    "speak_response, визор — set_hud_state. Железо слабое: отвечай ОДНИМ коротким "
    "вызовом, без лишних слов. Голосом правишь пунктуацией: … — пауза, критические "
    "данные разделяй точками. Без markdown и шаблонов."
)
